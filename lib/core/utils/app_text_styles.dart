...
abstract class CustomTextStyles {
  static final openSans400style64Brown = TextStyle(
    fontSize: 64,
    fontWeight: FontWeight.w400,
    color: AppColors.primaryColor,
    fontFamily: "Open Sans",
  );
  static final openSans400style20 = TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.w400,
    color: AppColors.primaryColor,
    fontFamily: "Open Sans",
  ...
  static final openSansBoldStyle24 = TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.bold,
    color: AppColors.black,
    fontFamily: "Open Sans",
  );
  static final openSansBoldStyle24Blue = TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.bold,
    color: AppColors.primaryColor,
    fontFamily: "Open Sans",
  );
  static final openSansBoldStyle40 = TextStyle(
    fontSize: 40,
    fontWeight: FontWeight.bold,
    color: AppColors.black,
    fontFamily: "Open Sans",
  ...
  static final openSans400style16Grey = TextStyle(
    fontSize: 16,
    letterSpacing: 1,
    fontWeight: FontWeight.bold,
    color: AppColors.darkGrey,
  ...
  static final openSans400style24Blue = TextStyle(
    fontSize: 24,
    letterSpacing: 1,
    fontWeight: FontWeight.bold,
    color: AppColors.primaryColor,
  ...
  static final openSans400style16 = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w400,
    color: AppColors.primaryColor,
    fontFamily: "Open Sans",
  );
  static final openSans400style24 = TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.w400,
    color: AppColors.black,
    fontFamily: "Open Sans",
